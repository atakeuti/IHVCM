...
namespace HumanVentricularCell
{
    public class cINajs : cElement
    {
        ...
        override public void Initialize(ref double[] myTVc, ref cCell myCell, ref ListForm Lf)
        {
            ...
            Lf.DGViews_Initialize(Lf.tpINajs_ListView, NumOfIx);

            m = myTVc[Pd.IdxINa_m_js];
            h = myTVc[Pd.IdxINa_h_js];
            j = myTVc[Pd.IdxINa_j_js];
            Itc = myTVc[Pd.InxINajs_Itc];
        }
        ...
        override public void dydt(double dt, ref double[] tvDYdt, ref double[] tvY, cCell myCell)
        {
            ...
            m = tvY[Pd.IdxINa_m_js];
            tvDYdt[Pd.IdxINa_m_js] = (m_inf - m) / m_tau;
            ...
            if (Vm < -40)
            {
                ...
                h = tvY[Pd.IdxINa_h_js];
                tvDYdt[Pd.IdxINa_h_js] = (h_inf - h) / h_tau;
                ...
                j = tvY[Pd.IdxINa_j_js];
                tvDYdt[Pd.IdxINa_j_js] = (j_inf - j) / j_tau;
            }
            else
            {
                //fast inactivation gate : h
            ...
            Itc = SF * myCell.JS.fraction_js * gNa * m * m * m * h * j * (Vm - myCell.Rp.Najs);
            myCell.TVc[Pd.InxINajs_Itc] = Itc;
        }

        override public void DispValues(ref ListForm Lf, ref double[] myTVc)
        {
            ucListView ListView = Lf.tpINajs_ListView;
            ListView.LVDispValue("INajs", IxSF, ref SF);
            ListView.LVDispValue("INajs", IxItc, ref Itc);
            ListView.LVDispValue("INajs", IxgNa, ref gNa);

            ListView.LVDispValue("INajs", Ixm, ref myTVc[Pd.IdxINa_m_js]);
            ListView.LVDispValue("INajs", Ixm_inf, ref m_inf);
            ListView.LVDispValue("INajs", Ixm_tau, ref m_tau);

            ListView.LVDispValue("INajs", Ixh, ref myTVc[Pd.IdxINa_h_js]);
            ListView.LVDispValue("INajs", Ixh_inf, ref h_inf);
            ListView.LVDispValue("INajs", Ixh_tau, ref h_tau);

            ListView.LVDispValue("INajs", Ixj, ref myTVc[Pd.IdxINa_j_js]);
            ListView.LVDispValue("INajs", Ixj_inf, ref j_inf);
            ListView.LVDispValue("INajs", Ixj_tau, ref j_tau);
        }

        override public void ModiValues(ref ListForm Lf, ref double[] myTVc)
        {
            ucListView ListView = Lf.tpINajs_ListView;
            ListView.LVModiValue("INajs", IxSF, ref SF);
            ListView.LVModiValue("INajs", IxItc, ref Itc);
            ListView.LVModiValue("INajs", IxgNa, ref gNa);

            ListView.LVModiValue("INajs", Ixm, ref myTVc[Pd.IdxINa_m_js]);
            ListView.LVModiValue("INajs", Ixm_inf, ref m_inf);
            ListView.LVModiValue("INajs", Ixm_tau, ref m_tau);

            ListView.LVModiValue("INajs", Ixh, ref myTVc[Pd.IdxINa_h_js]);
            ListView.LVModiValue("INajs", Ixh_inf, ref h_inf);
            ListView.LVModiValue("INajs", Ixh_tau, ref h_tau);

            ListView.LVModiValue("INajs", Ixj, ref myTVc[Pd.IdxINa_j_js]);
            ListView.LVModiValue("INajs", Ixj_inf, ref j_inf);
            ListView.LVModiValue("INajs", Ixj_tau, ref j_tau);
        }
    }
}
